...
from DL.Config import class_number, fix_length
...
class Transformer(nn.Module):
    def __init__(self,
        ...
        model = Word2Vec.load("D:\\论文代码开源\\question_classify\\word2vec.model")
        weights = torch.FloatTensor(model.wv.vectors)
        self.embed = nn.Embedding.from_pretrained(weights, freeze=False)
        ...
        self.fc1 = nn.Linear(dim_model, n_class)
